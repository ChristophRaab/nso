...
def get_loader(name_dataset, batch_size, train=True,path=None):
    ...
    mean_std = {
        ...
        'Caltech':{
            'mean': [0.63555413, 0.62481976, 0.6235004 ],
            'std': [0.2749024 , 0.27360195, 0.2694583 ]
        },
    }
    ...
    dataset = datasets.ImageFolder(root=path+ name_dataset,
